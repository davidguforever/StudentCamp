//
//  MTWalkthroughViewController.swift
//
...
@objc public protocol MTWalkthroughViewControllerDelegate{
...
@objc public protocol MTWalkthroughPage{
...
@objc open class MTWalkthroughViewController: UIViewController, UIScrollViewDelegate {
    
    weak open var delegate: MTWalkthroughViewControllerDelegate?
    ...
    override open func viewDidLoad() {
        ...
        pageControl?.addTarget(self, action: #selector(MTWalkthroughViewController.pageControlDidTouch), for: UIControl.Event.touchUpInside)
    ...
    open func scrollViewDidScroll(_ sv: UIScrollView) {
        ...
        for i in 0 ..< controllers.count {
            ...
            if let vc = controllers[i] as? MTWalkthroughPage {
