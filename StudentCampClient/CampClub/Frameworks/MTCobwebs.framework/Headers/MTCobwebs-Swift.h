...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MTCobwebs",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// 长按手势事件
SWIFT_CLASS("_TtC9MTCobwebs14BlockLongPress")
...
/// 手势绑定事件
SWIFT_CLASS("_TtC9MTCobwebs8BlockPan")
...
/// 捏合手势事件
SWIFT_CLASS("_TtC9MTCobwebs10BlockPinch")
...
/// 轻扫手势事件
SWIFT_CLASS("_TtC9MTCobwebs10BlockSwipe")
...
/// 点击绑定事件
SWIFT_CLASS("_TtC9MTCobwebs8BlockTap")
...
@interface NSTimer (SWIFT_EXTENSION(MTCobwebs))
/// execute block
+ (void)executeBlock:(NSTimer * _Nonnull)timer;
@end
...
@interface UIApplication (SWIFT_EXTENSION(MTCobwebs))
...
@interface UIImageView (SWIFT_EXTENSION(MTCobwebs))
/// 是否识别面部
...
@interface UITextField (SWIFT_EXTENSION(MTCobwebs))
...
@interface UITextView (SWIFT_EXTENSION(MTCobwebs))
/// 是否允许长按显示菜单  此处屏蔽 复制，选择全部，粘贴
@property (nonatomic) BOOL canPerformAction;
/// override canPerformAction
- (BOOL)canPerformAction:(SEL _Nonnull)action withSender:(id _Nullable)sender SWIFT_WARN_UNUSED_RESULT;
...
@interface UIView (SWIFT_EXTENSION(MTCobwebs))
/// 隐藏键盘结束编辑
- (void)hideKeyboard;
@end
