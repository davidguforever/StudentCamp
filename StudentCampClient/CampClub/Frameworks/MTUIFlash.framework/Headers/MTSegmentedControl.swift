...
@IBDesignable
open class MTSegmentedControl: UIView {
    ...
    @IBInspectable open var containerBackgroundColor: UIColor = MTSegmentedControl.UIColorFromRGB(0xF4F4F4)
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [MTSegmentedControl.UIColorFromRGB(0xFFE900),MTSegmentedControl.UIColorFromRGB(0xFFB400)]
    @IBInspectable open var thumbShadowColor: UIColor = MTSegmentedControl.UIColorFromRGB(0x9B9B9B)
    ...
    @IBInspectable open var segCornerRadius: CGFloat = -1 // for rounded corner radius use negative value, 0 to disable
    ...
    open override func layoutSubviews() {
        ...
        containerView.layer.cornerRadius = segCornerRadius < 0 ? 0.5 * containerView.frame.size.height : segCornerRadius
...
extension MTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbView.layer.cornerRadius = segCornerRadius < 0 ? 0.5 * thumbView.frame.size.height : segCornerRadius
